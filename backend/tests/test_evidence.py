"""PR8: evidence checker — neutral when no evidence, otherwise judges vs evidence."""
...
async def test_neutral_when_no_evidence(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert sig.suspicion == 0.5  # neutral — don't bias the panel
