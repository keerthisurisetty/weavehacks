/* ============================================================
   TELL — curated demo rounds + detector identities
   Each round is a flat list of timed steps the player walks.
   step kinds:
     {k:'phase', phase, banner}
     {k:'say', who:'speaker'|'ce'|'human', text}
     {k:'sig', d, s, status, r}        // detector signal -> meter + feed
     {k:'beat', ms}
     {k:'verdict', label, conf, decisive, contributing, head}
     {k:'reveal'}
   ============================================================ */
...
const PHASES = ['SETUP', 'INTERROGATING', 'DELIBERATING', 'VERDICT'];
...
const ROUNDS = [
  /* ---------------------------------------------------------- ROUND 1 — HONEST */
  {
    ...
    script: [
      ...
      { k: 'sig', d: 'ba', s: 0.10, status: 'confident', r: 'Low hedging. Commits to specifics. No evasion or distancing markers.' },
  ...
  /* ---------------------------------------------------------- ROUND 2 — STRATEGIC DECEPTION (the hero) */
  {
    id: 'r_strategic',
    ...
    script: [
      ...
      { k: 'sig', d: 'ce', s: 0.41, status: 'uncertain', r: 'Never said who or why specifically. Notice: no false statement yet — just no commitment. Pinning attendees next.' },
  ...
  /* ---------------------------------------------------------- ROUND 3 — HALLUCINATION */
  {
    ...
    script: [
      ...
      { k: 'sig', d: 'ev', s: 0.30, status: 'uncertain', r: 'Searching: no NeurIPS 2024 paper by Lindqvist with that title. No arXiv match either. Widening the query.' },
      ...
      { k: 'sig', d: 'ba', s: 0.80, status: 'flagging', r: 'High confidence, zero uncertainty markers, escalating specificity. Textbook confidence-vs-content mismatch.' },
...
Object.assign(window, { DETECTORS, ROUNDS, PHASES, MODE_LABEL });
